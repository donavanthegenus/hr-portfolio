  ...
  return (
    <section id="testimonials" className={styles.section}>
      <div className={styles.container}>
        <p className={styles.sectionLabel}>Colleagues</p>
